...
typedef GPB_ENUM(NCProtoDeviceType) {
  ...
  NCProtoDeviceType_DeviceTypeUnspecified = 0,
  NCProtoDeviceType_DeviceTypeAndroid = 1,
  NCProtoDeviceType_DeviceTypeIos = 2,
  NCProtoDeviceType_DeviceTypePc = 3,
};
...
typedef GPB_ENUM(NCProtoAppID) {
  /**
   * Value used if any message's field encounters a value that is not defined
   * by this enum. The message will also have C functions to get/set the rawValue
   * of the field.
   **/
  NCProtoAppID_GPBUnrecognizedEnumeratorValue = kGPBUnrecognizedEnumeratorValue,
  NCProtoAppID_AppidUnspecified = 0,
  NCProtoAppID_AppidNetcloth = 1,

  /** new app, to be determined */
  NCProtoAppID_AppidQIsland = 2,
};
 ...
 * the time this source was generated.
 **/
BOOL NCProtoAppID_IsValidValue(int32_t value);

#pragma mark - Enum NCProtoPushChannel

typedef GPB_ENUM(NCProtoPushChannel) {
  /**
   * Value used if any message's field encounters a value that is not defined
   * by this enum. The message will also have C functions to get/set the rawValue
   * of the field.
   **/
  NCProtoPushChannel_GPBUnrecognizedEnumeratorValue = kGPBUnrecognizedEnumeratorValue,
  NCProtoPushChannel_PushChannelUnspecified = 0,
  NCProtoPushChannel_PushChannelApns = 1,
  NCProtoPushChannel_PushChannelUmeng = 2,
};
 ...
 * the time this source was generated.
 **/
BOOL NCProtoPushChannel_IsValidValue(int32_t value);
...
typedef GPB_ENUM(NCProtoRegisterReq_FieldNumber) {
  ...
  NCProtoRegisterReq_FieldNumber_AppId = 3,
};
...
@property(nonatomic, readwrite) NCProtoAppID appId;
...
/**
 * Fetches the raw value of a @c NCProtoRegisterReq's @c appId property, even
 * if the value was not defined by the enum at the time the code was generated.
 **/
int32_t NCProtoRegisterReq_AppId_RawValue(NCProtoRegisterReq *message);
/**
 * Sets the raw value of an @c NCProtoRegisterReq's @c appId property, allowing
 * it to be set to a value that was not defined by the enum at the time the code
 * was generated.
 **/
...
typedef GPB_ENUM(NCProtoRegisterRsp_FieldNumber) {
  ...
  NCProtoRegisterRsp_FieldNumber_Token = 3,
};
...
/** 某些错误码需要进一步操作，返回一个业务token，执行下一步操作 */
...
typedef GPB_ENUM(NCProtoDeviceTokenBind_FieldNumber) {
  NCProtoDeviceTokenBind_FieldNumber_DeviceType = 1,
  NCProtoDeviceTokenBind_FieldNumber_DeviceToken = 2,
  NCProtoDeviceTokenBind_FieldNumber_PushChannel = 3,
};

@interface NCProtoDeviceTokenBind : GPBMessage

@property(nonatomic, readwrite) NCProtoDeviceType deviceType;

@property(nonatomic, readwrite, copy, null_resettable) NSString *deviceToken;

@property(nonatomic, readwrite) NCProtoPushChannel pushChannel;

@end

/**
 * Fetches the raw value of a @c NCProtoDeviceTokenBind's @c deviceType property, even
 * if the value was not defined by the enum at the time the code was generated.
 **/
int32_t NCProtoDeviceTokenBind_DeviceType_RawValue(NCProtoDeviceTokenBind *message);
/**
 * Sets the raw value of an @c NCProtoDeviceTokenBind's @c deviceType property, allowing
 * it to be set to a value that was not defined by the enum at the time the code
 * was generated.
 **/
...
/**
 * Fetches the raw value of a @c NCProtoDeviceTokenBind's @c pushChannel property, even
 * if the value was not defined by the enum at the time the code was generated.
 **/
int32_t NCProtoDeviceTokenBind_PushChannel_RawValue(NCProtoDeviceTokenBind *message);
/**
 * Sets the raw value of an @c NCProtoDeviceTokenBind's @c pushChannel property, allowing
 * it to be set to a value that was not defined by the enum at the time the code
 * was generated.
 **/
...
typedef GPB_ENUM(NCProtoDeviceTokenUnbind_FieldNumber) {
  NCProtoDeviceTokenUnbind_FieldNumber_DeviceType = 1,
  NCProtoDeviceTokenUnbind_FieldNumber_DeviceToken = 2,
  NCProtoDeviceTokenUnbind_FieldNumber_PushChannel = 3,
};

@interface NCProtoDeviceTokenUnbind : GPBMessage
...
/**
 * Fetches the raw value of a @c NCProtoDeviceTokenUnbind's @c deviceType property, even
 * if the value was not defined by the enum at the time the code was generated.
 **/
int32_t NCProtoDeviceTokenUnbind_DeviceType_RawValue(NCProtoDeviceTokenUnbind *message);
/**
 * Sets the raw value of an @c NCProtoDeviceTokenUnbind's @c deviceType property, allowing
 * it to be set to a value that was not defined by the enum at the time the code
 * was generated.
 **/
...
/**
 * Fetches the raw value of a @c NCProtoDeviceTokenUnbind's @c pushChannel property, even
 * if the value was not defined by the enum at the time the code was generated.
 **/
int32_t NCProtoDeviceTokenUnbind_PushChannel_RawValue(NCProtoDeviceTokenUnbind *message);
/**
 * Sets the raw value of an @c NCProtoDeviceTokenUnbind's @c pushChannel property, allowing
 * it to be set to a value that was not defined by the enum at the time the code
 * was generated.
 **/
