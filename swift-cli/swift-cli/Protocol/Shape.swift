...
extension UIView {
    ...
    //set sub self, color to default, then clear it self
    ...
    open func setCorner(size:CGFloat, maskedCorners:[CACornerMask])  {
        ...
        if #available(iOS 11.0, *) {
            ...
            //
            //            let fieldPath = UIBezierPath.init(roundedRect: self.bounds,
