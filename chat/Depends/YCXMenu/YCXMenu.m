...
#define kSeparatorInsetLeft     15.f
#define kSeparatorInsetRight    15.f
#define kSeparatorHeight        1.f
#define kSeparatorColor [UIColor colorWithRed:237/255.0 green:239/255.0 blue:242/255.0 alpha:1]
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        self.backgroundColor = [UIColor colorWithRed:48/255.0 green:49/255.0 blue:51/255.0 alpha:0.6];
        self.opaque = NO;
...
- (UIView *)mkContentView {
    ...
    const CGFloat kMarginX = kSeparatorInsetLeft / 2;
    ...
    const CGFloat kImgDiffTitle = 12.f;
    if (maxImageWidth) {
        maxImageWidth += kImgDiffTitle;
    }
    ...
    for (YCXMenuItem *menuItem in _menuItems) {
        ...
        if (menuItem.image) {
            ...
            const CGRect imageFrame = {kMarginX * 2, [YCXMenu menuItemMarginY], maxImageWidth - kImgDiffTitle, maxItemHeight - [YCXMenu menuItemMarginY] * 2};
