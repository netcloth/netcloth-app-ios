//
//  TokenTradeStatisticsVC.swift
//  chat
//
//  Created by Grand on 2020/4/21.
...
//    fileprivate var once = 0
//    override func viewDidAppear(_ animated: Bool) {
//        super.viewDidAppear(animated)
//        if once != 0 {
//            if let item = self.currentViewController as? TokenTradeListVC {
//                item.fetchData()
//            }
//        }
//        once = 1
...
//        let top:CGFloat = (self.navigationController?.navigationBar.frame.maxY ?? 0 ) + 86 + 4 + 59
        let top: CGFloat = 59
