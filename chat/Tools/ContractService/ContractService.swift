...
class ContractService: NSObject {
    ...
    static func findAllIPALList() -> Promise<EnterPoint> {
        let _promise = Promise<EnterPoint> { (resolver) in
            ...
            amount["amount"] = "0"
            para["amount"] = amount
//            "{\"from\":\"nch17czruqxgl2ndye4p0z86hn7a25mwl5lh89j9ur\",\"to\":\"nch17czruqxgl2ndye4p0z86hn7a25mwl5lh89j9ur\",\"payload\":\"a23e3e08000000000000000000000000c7bb0a77e5dc6de40214c1bb074cca2503bf10d2\",\"amount\":{\"denom\": \"pnch\",\"amount\": \"0\"}}"
